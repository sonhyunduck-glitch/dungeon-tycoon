...
/* 소켓 베이스 티어 — 층 구간별 상위 골격(이름·스탯 강화). idx: 0(~149) / 1(150~399) / 2(400+) */
G.DATA.SOCKET_TIER_MULT = [1.0, 1.4, 1.9];
G.DATA.SOCKET_TIER_NAMES = {
  "검":["검","장검","대검"], "도끼":["손도끼","전투도끼","전쟁도끼"], "단검":["단검","비수","월아"],
  "투구":["가죽모","사슬투구","판금투구"], "갑옷":["가죽갑옷","사슬갑옷","판금갑옷"],
  "장갑":["가죽장갑","사슬장갑","판금건틀릿"], "신발":["가죽신","사슬각반","판금각반"]
};
/* 소켓 베이스 품질 — 같은 골격이라도 굴림 편차(접두 + 주스탯 배율). w=가중치(하급 흔함) */
G.DATA.SOCKET_QUALITY = [
  { name:"녹슨",   mult:0.85, w:28, cls:"r-common" },
  { name:"낡은",   mult:0.95, w:34, cls:"r-common" },
  { name:"튼튼한", mult:1.10, w:22, cls:"r-uncommon" },
  { name:"정교한", mult:1.25, w:12, cls:"r-rare" },
  { name:"최상급", mult:1.45, w:4,  cls:"r-epic" }
];
...
G.DATA.RUNEWORD_OPEN_FLOOR = 150;   // 이 층 돌파 시 전체 룬워드 레시피 공개
