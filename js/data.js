...
G.DATA.RUNES = [
  ...
  { rank:11, name:"업화", iconImg:"assets/icon/runs/11.png", w:7,    wpn:{lifesteal:5},         arm:{thorns:12} },
  { rank:12, name:"멸각", iconImg:"assets/icon/runs/12.png", w:5,    wpn:{atk:14},              arm:{def:10} },
  { rank:13, name:"천뢰", iconImg:"assets/icon/runs/13.png", w:3,    wpn:{multihit:5},          arm:{stunResist:15} },
  { rank:14, name:"성휘", iconImg:"assets/icon/runs/14.png", w:2,    wpn:{critDmg:18},          arm:{hp:45} },
  { rank:15, name:"종언", iconImg:"assets/icon/runs/15.png", w:1,    wpn:{crit:5,penet:5},      arm:{allRes:8} },
  { rank:16, name:"심연", iconImg:"assets/icon/runs/16.png", w:0.8,  wpn:{lifesteal:6},         arm:{allRes:10} },
  { rank:17, name:"명동", iconImg:"assets/icon/runs/17.png", w:0.64, wpn:{atk:18},              arm:{stunResist:18} },
  { rank:18, name:"연무", iconImg:"assets/icon/runs/18.png", w:0.5,  wpn:{penet:8},             arm:{dodge:6} },
  { rank:19, name:"진공", iconImg:"assets/icon/runs/19.png", w:0.4,  wpn:{multihit:6},          arm:{hp:55} },
  { rank:20, name:"빙벽", iconImg:"assets/icon/runs/20.png", w:0.32, wpn:{critDmg:20},          arm:{def:14} },
  { rank:21, name:"낙일", iconImg:"assets/icon/runs/21.png", w:0.26, wpn:{atk:20},              arm:{allRes:10} },
  { rank:22, name:"월영", iconImg:"assets/icon/runs/22.png", w:0.2,  wpn:{crit:6},              arm:{dodge:7} },
  { rank:23, name:"성운", iconImg:"assets/icon/runs/23.png", w:0.16, wpn:{elemAtk:14},          arm:{allRes:12} },
  { rank:24, name:"암영", iconImg:"assets/icon/runs/24.png", w:0.13, wpn:{critDmg:24},          arm:{thorns:18} },
  { rank:25, name:"린광", iconImg:"assets/icon/runs/25.png", w:0.1,  wpn:{crit:7,critDmg:10},   arm:{allRes:12} },
  { rank:26, name:"귀곡", iconImg:"assets/icon/runs/26.png", w:0.08, wpn:{lifesteal:7},         arm:{stunResist:20} },
  { rank:27, name:"삭풍", iconImg:"assets/icon/runs/27.png", w:0.064,wpn:{multihit:8},          arm:{resCold:20} },
  { rank:28, name:"균열", iconImg:"assets/icon/runs/28.png", w:0.05, wpn:{penet:12},            arm:{thorns:22} },
  { rank:29, name:"식멸", iconImg:"assets/icon/runs/29.png", w:0.04, wpn:{elemAtk:18,crit:5},   arm:{allRes:14} },
  { rank:30, name:"인과", iconImg:"assets/icon/runs/30.png", w:0.032,wpn:{critDmg:28},          arm:{hp:70} },
  { rank:31, name:"신벌", iconImg:"assets/icon/runs/31.png", w:0.025,wpn:{atk:26,crit:6},       arm:{allRes:16} },
  { rank:32, name:"영면", iconImg:"assets/icon/runs/32.png", w:0.02, wpn:{lifesteal:8,multihit:8}, arm:{hp:90} },
  { rank:33, name:"연옥", iconImg:"assets/icon/runs/33.png", w:0.015,wpn:{critDmg:35,penet:10}, arm:{allRes:18,thorns:25} },
];
