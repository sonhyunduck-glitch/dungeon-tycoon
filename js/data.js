...
G.DATA.ENEMY_ANIMS = {
  /* Phase B 신규 32종 */
  giant_slime: { atk:16, hurt:8, die:7 },
  ...
  /* 원본 26종 (슬라이서로 모션 추가) */
  slime: { atk:7, hurt:4, die:7 },
  bat: { atk:5, die:5 },
  goblin: { atk:6, hurt:4, die:6 },
  skeleton: { atk:8, hurt:8, die:8 },
  spider: { atk:4, hurt:3, die:9 },
  wolf: { atk:7, hurt:4, die:4 },
  orc: { atk:7, hurt:4, die:6 },
  golem: { atk:5, hurt:5, die:10 },
  ghost: { atk:8, hurt:5, die:9 },
  lich: { atk:5, hurt:4, die:16 },
  fire_elem: { atk:8, hurt:6, die:8 },
  ice_elem: { atk:5, hurt:3, die:8 },
  snake: { atk:5, hurt:5, die:5 },
  harpy: { atk:5, hurt:5, die:7 },
  wyvern: { atk:10, hurt:5, die:10 },
  octopus: { atk:4, hurt:6, die:7 },
  eye: { atk:4, die:8 },
  goblin_lord: { atk:7, hurt:7, die:8 },
  orc_chief: { atk:6, hurt:3, die:6 },
  witch: { atk:8, hurt:4, die:10 },
  fire_giant: { atk:6, hurt:4, die:7 },
  ice_dragon: { atk:10, hurt:8, die:10 },
  demon_lord: { atk:6, hurt:4, die:5 },
  fallen_angel: { atk:8, hurt:8, die:7 },
  ancient_dragon: { atk:8, hurt:4, die:8 },
  demon_king: { atk:8, hurt:4, die:5 },
  skeleton_king: { atk:7, hurt:4, die:9 },
  minotaur: { atk:9, hurt:3, die:6 }
};
