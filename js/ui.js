...
G.ui.render = function(){
  ...
  // 탭이 바뀌면 이전 탭 뷰의 DOM을 비움 — 숨겨진 뷰가 옛 내용을 들고 있지 않도록
  if(G.ui._lastTab && G.ui._lastTab!==tab){
    var prev=el("view-"+G.ui._lastTab); if(prev) prev.innerHTML="";
  }
  G.ui._lastTab=tab;
  ...
  G.ui.renderLog();
  if(G.ui.updateSettleFab) G.ui.updateSettleFab();   // 미정산 전리품 플로팅 버튼
